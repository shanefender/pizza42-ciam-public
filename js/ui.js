...
const router = {
  ...
  "/orders": () =>
    requireAuth(() => showContent("orders"), "/orders"),
  "/verify-email": () =>
    requireAuth(() => showContent("verify-email"), "/verify-email"),
  "/login": () => login()
};
...
const updateUI = async () => {
  try {
    ...
    if (isAuthenticated) {
      ...
      eachElement(".user-email-verified", (e) => (e.innerText = user.email_verified));
